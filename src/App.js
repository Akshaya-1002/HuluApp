...
function App() {
  ...
  const handleLoginLinkClick = (e) => {
    if (!email || !password) {
      e.preventDefault();
      setErrorMessage("NOTE: Please enter all fields.");
    }
  };
    ...
    <div className="container">
      <div className="container_1">
        <div className="navbar">
          ...
          >
            <div className="modal-box">
              <div className="modal-body">
                ...
                <form>
                  ...
                  <div className="sign_up">
                    <Link to="/signup" onClick={handleLoginLinkClick}>
                      LOG IN
                    </Link>
                  </div>
                  <br />
              ...
              <i className="close" onClick={() => setModalOpen(false)}>
                <CloseIcon />
              </i>
            </div>
          </div>
        ...
        <div className="main_box">
          <div className="box_left">
            ...
            <img
              src="https://cnbl-cdn.bamgrid.com/assets/f1607ad0edca860aef966f4295fcb94be1af04de5aefcf855bc080b778448bef/original"
              alt="box_left"
            />
            <h1>
      ...
      <div className="container_2">
        ...
        <p className="line_3">
          ...
          episodes, hit movies, Hulu <br /> Originals, kids shows, and more.
        </p>
        <br />
        <div className="cards">
        ...
        <div className="part_2">
          ...
          <p className="line_3">
            Get 95+ top channels on Hulu (With Ads) + Live TV with your favorite
            live sports, news, <br /> and events - plus the entire Hulu
            streaming library. With Unlimited DVR, store Live TV <br />{" "}
